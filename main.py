...
def mostrar_menu():
    ...
    titulo.pack(pady=20)
    msg = ctk.CTkLabel(app, text="Cada realidade financeira é diferente. Use esta regra como referência e adapte conforme suas prioridades.", font=("Arial", 14, "italic"), wraplength=350, justify="center")
    msg.pack(pady=10)
...
def tela_orcamento():
    ...
    ctk.CTkLabel(app, text="Digite sua renda").pack(pady=10) #cria e posiciona o texto
...
def tela_cartao():
    ...
    ctk.CTkLabel(app, text="Digite sua renda").pack(pady=5)
    entry_renda = ctk.CTkEntry(app)
    entry_renda.pack(pady=5)

    ctk.CTkLabel(app, text="Limite do cartão").pack(pady=5)
...
def tela_simulador():
    ...
    ctk.CTkLabel(app, text="Valor do produto").pack(pady=5)
